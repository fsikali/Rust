...
// method whose implementation is required, and then define a summarize method 
...
// N/B - Note that it isn’t possible to call the default implementation from an overriding implementation of that same method.
